...
<head>
    ...
    <title> Feedback | SuperMart Admin</title>
</head>
...
<body>
    ...
    <table class="table table-striped table-condensed">
        ...
        $records = mysqli_query($con, "select * from feedback"); // fetch data from database
        ...
        ?>
            <tr>
                ...
                <td><?php echo $data['service_rating']; ?></td>
                <td><?php echo $data['recommend']; ?></td>
                <td><?php echo $data['suggestion']; ?></td>
                <td><?php echo $data['received_at']; ?></td>
            </tr>
        <?php
        }
        ?>
