  ...
  <section class="text-gray-700 body-font">
    <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
      <div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
        <h1 class="title-font font-medium text-3xl text-gray-900">SuperMart for online platform to purchase Grocery online with ease!</h1>
        <p class="leading-relaxed mt-4">We at SuperMart take care of all your needs of Grocery while maintaing Hygine.</p>
      </div>
    </div>
  </section>
  ...
  <section class="text-gray-700 body-font">
    <div class="container px-5 py-24 mx-auto flex items-center md:flex-row flex-col">
      <div class="flex flex-col md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto md:text-left text-center">
        <h2 class="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">For Best Experience</h2>
        <h1 class="md:text-3xl text-2xl font-medium title-font text-gray-900">We are on Google Play and App Store</h1>
      </div>
